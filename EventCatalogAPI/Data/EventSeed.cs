...
namespace EventCatalogAPI.Data
{
    public class EventSeed
    {
        ...
        private static IEnumerable<Event> GetPreconfiguredEvents()
        {
            ...
            {
                new Event() { EventCategoryId=3,EventMetroAreaId=1, Price= 29.99,
                ...
                new Event() { EventCategoryId=4,EventMetroAreaId=2, Price= 0,
                ...
                new Event() { EventCategoryId=1,EventMetroAreaId=3, Price= 79.99,
                ...
                new Event() { EventCategoryId=1,EventMetroAreaId=4, Price= 69.99,
                ...
                new Event() { EventCategoryId=3,EventMetroAreaId=5, Price= 109.99,
                ...
                new Event() { EventCategoryId=2,EventMetroAreaId=6, Price= 0,
                ...
                new Event() { EventCategoryId=2,EventMetroAreaId=1, Price= 19.99,
                ...
                new Event() { EventCategoryId=4,EventMetroAreaId=3, Price= 0,
                ...
                new Event() { EventCategoryId=4,EventMetroAreaId=4, Price= 0,
                ...
                new Event() { EventCategoryId=3,EventMetroAreaId=5, Price= 10.95,
                ...
                new Event() { EventCategoryId=3,EventMetroAreaId=6, Price= 54.99,
                ...
                new Event() { EventCategoryId=1,EventMetroAreaId=1, Price= 24.99,
                ...
                new Event() { EventCategoryId=2,EventMetroAreaId=2, Price= 19.99,
                ...
                new Event() { EventCategoryId=4,EventMetroAreaId=4, Price= 129.99,
